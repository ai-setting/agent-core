...
} from "agent-core/environment/base/base-environment";
import type { Context } from "agent-core/types/context.js";
import type { Action } from "agent-core/types/action.js";
import type { StreamEvent } from "agent-core/environment/index.js";
  ...
  private async registerDefaultTools(): Promise<void> {
    try {
      const toolsModule = await import(
        "agent-core/environment/expend/os/tools/index.js"
      );
